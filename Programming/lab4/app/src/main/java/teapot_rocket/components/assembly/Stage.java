...
import teapot_rocket.components.body.BodyComponent;
...
public final class Stage extends AssemblyComponent {
     ...
     *                      {@link teapot_rocket.components.body.BodyComponent}
     ...
     *
     * @return The list of {@link teapot_rocket.components.body.BodyComponent}
     *         instances within the stage.
     *         Represents body components that compose the stage.
     */

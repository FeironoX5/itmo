...
import teapot_rocket.components.inner.InnerComponent;
...
import teapot_rocket.utils.interfaces.Rotatable;

/**
 * Represents a body tube component used in rocket construction.
 *
 * <p>
 * This class extends {@link teapot_rocket.components.body.BodyComponent} and
